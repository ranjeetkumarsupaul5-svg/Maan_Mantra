...
class StudentData(BaseModel):
    ...
    Study_Hours: int=Field(..., ge=0, le=24, description="Number of study hours per day (0-24)")
    Physical_Activity_Hours: int=Field(..., ge=0, le=24, description="Number of physical activity hours per day (0-24)")
    Sleep_Hours_Per_Night: int = Field(..., ge=0, le=24, description="Number of sleep hours per night (0-24)")
